...
public class LevelFive extends Scene {
    ...
    public LevelFive(Stage primaryStage, double WIDTH, double HEIGHT, int prefCrossHair, int prefGround) {
        ...
        primaryStage.getScene().addEventFilter(KeyEvent.KEY_PRESSED, event -> {
            if (event.getCode() == KeyCode.ESCAPE && lostLevel) {
                ...
                primaryStage.setScene(new LevelSix(primaryStage, WIDTH, HEIGHT, prefCrossHair, prefGround));
        ...
        blackDuck = incubatorNo3.hatchHorizontal(layout, SCALE, WIDTH, HEIGHT, 1, 1, "black", primaryStage);
